	 ...
	 <div class="flexslider">
		<ul class="slides">
		  <li>
			...
			<h4>Jhon & Mary</h4>
			<p>Happily married on June 27, 2015</p>
		  </li>
		  <li>
			<img src="images/s1.jpg" alt=""/>
			<h4>Annie & Williams</h4>
			<p>Happily married on March 23, 2019.</p>
		  </li>
		  <li>
			<img src="images/s3.jpg" alt=""/>
			<h4>Ram & Isha</h4>
			<p>It is a long established fact that they loved each other and got married on Jan 12, 2017.</p>
		  </li>
	    </ul>
	  </div>
   </section>
