	         ...
	         <ul> 
			   <li>
				  	<div class="suceess_story-date">
						<span class="entry-1">Jan 10, 2010</span>
					</div>
					<div class="suceess_story-content-container">
						...
						<div class="suceess_story-content-info">
				        	<h4><a href="#">Aneesh & Anitta</a></h4>				        	
				        	<p>Marital has played a great role in our life.We were struggling to find our life partners.Now, we are happy with each other. Thanks to marital!</p>
				        </div>
				    </div>
				</li>
	            <li>
				  	<div class="suceess_story-date">
						<span class="entry-1">Aug 13, 2011</span>
					</div>
					<div class="suceess_story-content-container">
						<figure class="suceess_story-content-featured-image">
						...
						<div class="suceess_story-content-info">
				        	<h4><a href="#">Sharad & Priyanka</a></h4>			        	
				        	<p>Thank you for helping us in finding our life-partner. Being a Jain, we never though we would like each other from different caste but we believe cast is just a state of mind. We love everything about each other.Thanks marital!!!</p>
				        </div>
				    </div>
				</li>
	            <li>
				  	<div class="suceess_story-date">
						<span class="entry-1">Dec 20, 2012</span>
					</div>
					<div class="suceess_story-content-container">
						<figure class="suceess_story-content-featured-image">
						...
						<div class="suceess_story-content-info">
				        	<h4><a href="#">Krishnadas TV & Soumya</a></h4>				        	
				        	<p>Marital has played a cupid role in our love story. It is unbelievable that it is an arranged marriage, as it looked more like a love marriage. Thank You!</p>
				        </div>
				    </div>
				</li>
	            <li>
				  	<div class="suceess_story-date">
						<span class="entry-1">Sep 21, 2017</span>
					</div>
					<div class="suceess_story-content-container">
						<figure class="suceess_story-content-featured-image">
						...
						<div class="suceess_story-content-info">
				        	<h4><a href="#">Anjush & Pahuja</a></h4>				        	
				        	<p>Marriage leads to the life of sharing, caring and endless love for each other. We are happy with each other.Thanks to marital team.</p>
				        </div>
				    </div>
				</li>
	            <li>
				  	<div class="suceess_story-date">
						<span class="entry-1">Nov 20, 2018</span>
					</div>
					<div class="suceess_story-content-container">
						<figure class="suceess_story-content-featured-image">
						...
						<div class="suceess_story-content-info">
				        	<h4><a href="#">Unnati Jain & Honey Jain</a></h4>				        	
				        	<p>Thanks a ton marital for helping me to meet my Life partner. I found my soulmate and I believe he is the best thing which has happened to my life . He is handsome, understanding and the awesome part is that we compliment each other.</p>
				        </div>
				    </div>
				</li>
	            <li>
				  	<div class="suceess_story-date">
						<span class="entry-1">Jan 2, 2018</span>
					</div>
					<div class="suceess_story-content-container">
						<figure class="suceess_story-content-featured-image">
						...
						<div class="suceess_story-content-info">
				        	<h4><a href="#">Deeksha & Nakul</a></h4>				        	
				        	<p>Thanks a ton marital for finding perfect match for us. I was settled in California and I was finding very difficult for finding the perfect match for myself. But now I am happy with him.  </p>
				        </div>
				    </div>
				</li>
	            <li>
				  	<div class="suceess_story-date">
						<span class="entry-1">Feb 18, 2019</span>
					</div>
					<div class="suceess_story-content-container">
						<figure class="suceess_story-content-featured-image">
						...
						<div class="suceess_story-content-info">
				        	<h4><a href="#">Dr Siddhant Bhardwaj & Dr Sri</a></h4>				        	
				        	<p>Thanks to Marital - Who helped to find my life partner "Sri" in spite of so many challenges. When I met her I realized she was way more than my expectations . Her personality, kindness and honesty have impressed me a lot.</p>
				        </div>
				    </div>
				</li>
	        </ul>
	      ...
	      <h3>News & Events</h3>
	        <div class="box_1">
			  ...
			  <div class="extra-wrap">
				...
				<h4 class="post-title"><a href="#">Premium Memberships</a></h4>
				<div class="clearfix"> </div>
				<div class="post-content">Premium memberships are going to be a part of our website.</div>
	        ...
	        <div class="box_1">
			  ...
			  <div class="extra-wrap">
				<div class="post-meta">
					<span class="day">
					<time datetime="2014-07-26T10:15:43+00:00">26</time>
					</span>
					<span class="month">
					<time datetime="2014-07-26T10:11:51+00:00">July</time>
					</span>
				</div>
				<h4 class="post-title"><a href="#">Why Is It Hard for An NRI To Get an Indian Partner?</a></h4>
				<div class="clearfix"> </div>
				<div class="post-content">Indians have an inseparable touch in almost everything from their traditions, history, genetic influence on their faith and beliefs. They are very closed in their circle, and at times, it becomes unmanageable to get well with the other cultures.Non-residents of India find it quite difficult to marry someone from the Indian community.</div>
			  </div>
	        </div>
	        <div class="box_2">
			  ...
			  <div class="extra-wrap">
				<div class="post-meta">
					<span class="day">
					<time datetime="2014-09-28T10:15:43+00:00">28</time>
					</span>
					<span class="month">
					<time datetime="2014-09-28T10:11:51+00:00">Sep</time>
					</span>
				</div>
				<h4 class="post-title"><a href="#">Why Choose A Matrimonial Site to Find the Love of Your Life?</a></h4>
				<div class="clearfix"> </div>
				<div class="post-content">Marriage is not a simple and straightforward process. It’s rather a vital turning point in every man and woman’s life. You can’t be careless while choosing your life companion.The more compatible your life partner is with you, the happier your life is sure to be.</div>
			  </div>
	        </div>
	        <div class="religion">
		...
		<div class="container"> 
            ...
            <div class="col-sm-6">
            	<div class="bg_left">
            		...
            		<p>Thanks to marital for providing my friend the partner of her life.</p>
            ...
            <div class="col-sm-6">
            	<div class="bg_left">
            		...
            		<p>Thanks to marital for providing my friend the partner of his life.</p>
            	   <ul class="team-socials">
                    <li><a href="#"><span class="icon-social "><i class="fa fa-facebook"></i></span></a></li>
                    <li><a href="#"><span class="icon-social "><i class="fa fa-twitter"></i></span></a></li>
                    <li><a href="#"><span class="icon-social"><i class="fa fa-google-plus"></i></span></a></li>
